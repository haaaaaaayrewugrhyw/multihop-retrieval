...
from fakencoder_train import (
    FakeEncoderModel, D_MODEL, D_PROJ, MAX_A_LEN, MAX_B_LEN,
)
...
def main():
    ...
    m1_ckpt = MODEL_DIR / "fakencoder_best.pt"
    if not m1_ckpt.exists():
        raise FileNotFoundError(
            f"Model 1 checkpoint not found: {m1_ckpt}\n"
            "Train Model 1 first: python fakencoder_train.py"
        )
